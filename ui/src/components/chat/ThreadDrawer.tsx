      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="absolute inset-y-0 left-0 z-50 flex w-72 flex-col bg-white/95 dark:bg-default-50/60 backdrop-blur-2xl border-r border-default-200 dark:border-default-200/50 rounded-l-2xl"
          >
            {/* Header */}
