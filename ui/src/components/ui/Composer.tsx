...
export const Composer: FC<ComposerProps> = ({
  ...
  return (
    <div className="aui-composer-root relative flex w-full flex-col rounded-xl border border-default-200 dark:border-default-200/50 bg-white dark:bg-default-100/80 backdrop-blur-2xl shadow-sm dark:shadow-none px-1 pt-2 outline-none transition-shadow has-[textarea:focus-visible]:border-primary/40 has-[textarea:focus-visible]:ring-2 has-[textarea:focus-visible]:ring-primary/20">
      <textarea
        ref={textareaRef}
        value={text}
