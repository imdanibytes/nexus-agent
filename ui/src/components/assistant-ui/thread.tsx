...
const AssistantActionBar: FC = () => {
  ...
  const timingSpans = useAuiState(
    (s) => (s.message.metadata?.custom as Record<string, unknown> | undefined)?.timingSpans as
      import("@/stores/chatStore.js").TimingSpan[] | undefined,
  );
  ...
  return (
    <>
      ...
      <Sheet open={debugOpen} onOpenChange={setDebugOpen}>
        <SheetContent side="right" className="sm:max-w-2xl w-[90vw] flex flex-col p-0">
